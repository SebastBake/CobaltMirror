 ...
 */
public class EditLocationListAdapter extends ArrayAdapter<Place> {
    ...
    public EditLocationListAdapter(Context context, int textViewResourceId, ArrayList<Place> items) {
